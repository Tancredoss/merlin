...
class TestScalewaySessionBasic:
    ...
    def test_confirm_backend_has_probs(self, scaleway_session):
    ...
    def test_simple_forward_probs_zero(self, scaleway_session):
    ...
    def test_simple_forward_probs_None(self, scaleway_session):
