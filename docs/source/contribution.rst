...
MerLin grows through community contributions to both the core framework and the reproduction ecosystem.
If you want to contribute code, docs, experiments, or benchmarking assets, start from one of the two repositories below.

Choose a Repository
===================

.. merlin-gallery::
   :data: _data/galleries/contribution_repositories.json
   :columns: 2
...
For reproduction submissions, follow the mandatory structure described in :doc:`reproduced_papers/reproduced_papers`.
