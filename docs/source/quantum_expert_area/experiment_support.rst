...
passing a :class:`perceval.components.experiment.Experiment` to :class:`~merlin.algorithms.layer.QuantumLayer` or to :class:`~merlin.algorithms.kernels.FeatureMap` lets you specify how each optical mode should be measured.
